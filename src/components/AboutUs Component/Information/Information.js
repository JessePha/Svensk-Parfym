...
import {text, text2, text3, text4, text5, text6, text7, text8, text9, text10, text11, text12} from '../../../shared/AboutUs.json';
  ...
  render() {
    ...
    return (
      <div className={classes.Information}>
          ...
          <div className={classes.TopText}>Perfumer Henrik Lestréus and the fine fragrances brand Svensk Parfym</div>
